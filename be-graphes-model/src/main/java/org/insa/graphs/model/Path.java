...
public class Path {
	...
	public boolean isValid() {
		...
		Node current = this.arcs.get(0).getOrigin();
		for (Arc arc : this.arcs) {
			if (arc.getOrigin() != current) {
				return false;
			}
	 ...
	 *         kilometers-per-hour). deprecated Need to be implemented. FAIT
	 */
	 ...
	 * 
	 *         deprecated Need to be implemented. FAIT
	 */
